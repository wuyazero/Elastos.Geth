...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/wuyazero/Elastos.Geth

    go install github.com/wuyazero/Elastos.Geth/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/wuyazero/Elastos.Geth`.

Most likely you will be working from your fork of `Elastos.Geth`, let's say from `github.com/nirname/Elastos.Geth`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/Elastos.Geth.git $GOPATH/src/github.com/wuyazero/Elastos.Geth
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/wuyazero/Elastos.Geth/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/wuyazero/Elastos.Geth/wiki/Code-Review-Guidelines).
