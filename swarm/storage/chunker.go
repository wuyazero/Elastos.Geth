...
import (
	...
	ch "github.com/wuyazero/Elastos.Geth/swarm/chunk"
...
type JoinerParams struct {
	...
	addr   Address
	getter Getter
	// TODO: there is a bug, so depth can only be 0 today, see: https://github.com/ethersphere/Elastos.Geth/issues/344
	depth int
	ctx   context.Context
}
