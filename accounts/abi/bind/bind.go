...
//
// Detailed usage document and tutorial available on the Elastos.Geth Wiki page:
// https://github.com/wuyazero/Elastos.Geth/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
