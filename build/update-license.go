...
var (
	...
	authorsFileHeader = "# This is the official list of Elastos.Geth authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The Elastos.Geth Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The Elastos.Geth library"
	}
	return "the Elastos.Geth library"
}
