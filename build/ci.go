...
import (
	...
	"github.com/wuyazero/Elastos.Geth/internal/build"
	"github.com/wuyazero/Elastos.Geth/params"
	sv "github.com/wuyazero/Elastos.Geth/swarm/version"
)
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("Elastos.Geth requires at least Go version 1.9 and cannot")
...
type debMetadata struct {
	...
	// Elastos.Geth version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/wuyazero/Elastos.Geth/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/wuyazero/Elastos.Geth/mobile")
